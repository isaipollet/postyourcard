        ...
        <header className="flex items-center justify-between gap-3 px-4 sm:px-8 lg:px-12 pt-4 sm:pt-5">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link
              ...
              className="shrink-0 flex items-center gap-1.5 rounded-full border border-white/60 bg-white/10 px-2.5 sm:px-4 py-1.5 sm:py-2 text-sm font-medium text-white backdrop-blur-sm hover:bg-white/20 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l3 3m0 0l-3 3m3-3H2.25" />
              </svg>
              <span className="hidden sm:inline">{t("home.login")}</span>
            </Link>
          </div>
        </header>
